...
@hsqldb:SNAME varchar(12) foreign key references SHELL001(SNAME),
@mssql:SNAME varchar(12) foreign key references SHELL001(SNAME),
@mysql:SNAME varchar(12) references SHELL001(SNAME),
    ENAME varchar(60) 
);

create table SHELL003 (
    PINDX numeric(12) primary key,
@hsqldb:EINDX numeric(12) foreign key references SHELL002(EINDX),
@mssql:EINDX numeric(12) foreign key references SHELL002(EINDX),
@mysql:EINDX numeric(12) references SHELL002(EINDX),
    PNAME varchar(60),
    VALUE varchar(60)
);
