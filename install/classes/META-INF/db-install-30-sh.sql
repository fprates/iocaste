...
insert into docs002(iname, docid, index, fname, ename, attrb, itref) values('SEARCH_HELP.MODEL', 'SEARCH_HELP', 1, 'DOCID', 'MODEL.NAME', 'model', 'MODEL.NAME');
insert into docs002(iname, docid, index, fname, ename, attrb, itref) values('SEARCH_HELP.EXPORT', 'SEARCH_HELP', 2, 'EXPRT', 'MODELITEM.NAME', 'export', 'MODELITEM.NAME');
...
insert into docs002(iname, docid, index, fname, ename, attrb, itref) values('SH_ITENS.SEARCH_HELP', 'SH_ITENS', 1, 'SHCAB', 'SEARCH_HELP.NAME', 'searchHelp', 'SEARCH_HELP.NAME');
insert into docs002(iname, docid, index, fname, ename, attrb, itref) values('SH_ITENS.ITEM', 'SH_ITENS', 2, 'MDITM', 'MODELITEM.NAME', 'modelItem', 'MODELITEM.NAME');
...
insert into docs002(iname, docid, index, fname, ename, attrb, itref) values('SH_REFERENCE.SEARCH_HELP', 'SH_REFERENCE', 1, 'SHCAB', 'SEARCH_HELP.NAME', 'searchHelp', 'SEARCH_HELP.NAME');
