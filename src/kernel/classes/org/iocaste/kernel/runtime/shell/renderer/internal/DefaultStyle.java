...
public class DefaultStyle {
    ...
    static {
        ...
        constants.put(StyleConst.FONT_COLOR,
                "#444");
        constants.put(StyleConst.FONT_FAMILY,
                "'Lato', 'Dejavu Sans', sans-serif");
        constants.put(StyleConst.BACKGROUND_COLOR,
                "#ffffff");
        constants.put(StyleConst.CLICKABLE_COLOR,
                "#298eea");
        constants.put(StyleConst.FRAME_COLOR,
                "rgb(237, 237, 237)");
        constants.put(StyleConst.DISABLED_FONT_COLOR,
                "rgb(150, 150, 150)");
        constants.put(StyleConst.FONT_SIZE,
                "11pt");
        constants.put(StyleConst.SHADOW,
                "1px 1px 2px #b0b0b0");
        constants.put(StyleConst.CONTROL_BACKGROUND,
        ...
        resolutions.put("mobile0", new Object[][] {
            ...
            {"none",
                new String[][] {
                    ...
                    {"border-bottom-color", constants.get(StyleConst.FRAME_COLOR)},
                    {"display", "table-row"}},
                new String[][] {
    ...
    public static final StyleSheet instance(
        ...
        stylesheet = StyleSheet.instance(sheet, styleconst);
        ...
        DISABLED_FONT_COLOR = constants.get(StyleConst.DISABLED_FONT_COLOR);
        FONT_SIZE = constants.get(StyleConst.FONT_SIZE);
        SHADOW = constants.get(StyleConst.SHADOW);
        CONTROL_BACKGROUND = constants.get(StyleConst.CONTROL_BACKGROUND);
